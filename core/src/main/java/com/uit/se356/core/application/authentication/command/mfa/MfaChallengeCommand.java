...
public record MfaChallengeCommand(MfaMethod method, String verificationToken)
    implements Command<MfaChallengeResult> {
  public MfaChallengeCommand {
